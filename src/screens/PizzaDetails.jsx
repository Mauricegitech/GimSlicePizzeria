...
const PizzaDetails = () => {
  ...
  return (
    <Layout title={"GimSlice Pizzeria - Pizza-Details"}>
              ...
              <div className="row product justify-content-center mt-4 mb-4">
                ...
                <div className="col-md-6 d-flex align-items-center">
                  <div className="mt-4 mt-4 mt-md-0">
                    ...
                    <h3 className="product-price">Price: KES {pizza.price}</h3>
          ...
          {selectedPizza && (
            <>
              ...
              <div>
                ...
                <h3 className="product-price">Price: KES {selectedPizza.price}</h3>
                <h6 className="product-category">
