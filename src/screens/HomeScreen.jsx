...
const HomeScreen = () => {
  ...
  return (
    <>
      <Layout title={"GimSlice Pizzeria - Pizza Delivery"}>
                ...
                <div className="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                  <div>
                    <h1 className="text-uppercase fw-bold text-white mb-3">
                      Welcome to GimSlice Pizzeria
                    </h1>
                    <p className="mb-4" style={{ textAlign: "center" }}>
                      Indulge in a delightful culinary journey with GimSlice Pizzeria!
                      ...
                      at GimSlice Pizzeria, your go-to pizza destination for every
                      occasion.
                    </p>
                  </div>
                </div>
